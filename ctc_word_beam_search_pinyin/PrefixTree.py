...
class Node:
    ...
    def __str__(self):
        ...
        for (k, _) in self.children.items():
            s += [k]
        return 'isWord: ' + str(self.isWord) + '; children: ' + str(s)
...
if __name__ == '__main__':
    ...
    t.addWords([[1,2,3,4], [1,3,4,5]])  # add words
    print(t.getNextChars([1,2]))  # chars following [1,2]
    print(t.getNextWords([1,3]))  # all words of which [1,3] is prefix
